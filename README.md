...
Independent validation is deliberately not yet reported. It requires actual outputs from independently configured generators with immutable model revisions and complete provenance. The repository now provides the framework to ingest and evaluate them without fabricating data or results.
